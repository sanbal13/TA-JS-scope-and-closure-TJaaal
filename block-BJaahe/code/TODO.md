...
function display(wait) {
  setTimeout(() => {
  console.log(`This function is executed after a delay of ${wait/1000} secs.`, "Inside Display");
}, wait);
}
delay(display, 2000);
```
